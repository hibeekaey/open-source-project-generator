...
| `min_sdk` | integer | No | `24` | Minimum Android SDK level | Must be valid API level (21-36) |
| `target_sdk` | integer | No | `35` | Target Android SDK level | Must be valid API level (21-36), >= min_sdk |
